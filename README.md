...
| Mod | Version | |
| --- | --- | --- |
| [Pokeball Colorfix](https://github.com/keberos/pokeball-colorfix) | 1.1.0 | Colours every Poké Ball the engine leaves grey |
...
| [Pokedex Sprites (HGSS)](https://github.com/keberos/pokedex-sprites-hgss) | 1.0.0 | HeartGold/SoulSilver art on the Pokedex entry page, plus a modern caught-ball marker |
