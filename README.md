...
| [Button Shortcuts](https://github.com/keberos/button-shortcuts) | 0.2.1 | One-button TOWN MAP, BICYCLE, FLY, and battle ball throw — experimental, BIKE/BALL verified |
