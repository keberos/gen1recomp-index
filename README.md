...
| [Pokedex Sprites (HGSS)](https://github.com/keberos/pokedex-sprites-hgss) | 0.4.0 | HeartGold/SoulSilver art on the Pokedex entry page, plus a modern caught-ball marker — experimental |
