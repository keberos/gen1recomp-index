...
| [Pokedex Sprites (HGSS)](https://github.com/keberos/pokedex-sprites-hgss) | 0.3.0 | Swaps the Pokedex entry-page art for HeartGold/SoulSilver-style sprites — experimental |
